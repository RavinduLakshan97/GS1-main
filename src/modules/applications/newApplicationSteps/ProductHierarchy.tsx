...
import { productHierarchySchema } from "../../../utils/validations/railPartSchema";
...
type FormData = z.infer<typeof productHierarchySchema>;

const normalizedSchema = getNormalizedSchemaShape(productHierarchySchema);

type ProductHierarchyProps = {
  handleNext: () => void;
  handleBack: () => void;
  handleReset: () => void;
  activeStep: number;
...
const ProductHierarchy: React.FC<ProductHierarchyProps> = ({
  ...
  const {
    ...
    resolver: zodResolver(productHierarchySchema),
  ...
  const onSubmit = (data: FormData) => {
    console.log("isConsumer Unit", data.isConsumerUnit);
  ...
  return (
    ...
    >
      ...
      <Stack direction="row" spacing={2} justifyContent="center" mt={4}>
        ...
        {/* <CustomButton
          onClick={() => dispatch(openPopup("dashboard"))}
          variant="contained"
          color="secondary"
        >
          Popup
